...
<div class="bg-white">
    <header class="bg-[#E5CB90] text-white text-center py-12">
    ...
    <section class="bg-[#E5CB90] py-12 px-4">
        ...
        <form class="max-w-2xl mx-auto mt-8 space-y-8">
            ...
            <button type="submit"
                class="w-full bg-[#8B5E3C] text-white py-3 rounded-lg shadow-lg hover:bg-green-600 transition-colors">Send
                Message</button>
        </form>
    </section>
    <section class="text-center py-12 px-4">
